    ...
    bubbleDown(index){
        while(this.hasLeft(index)&&(this.heap[index]>this.getLeftChild(index)||(this.hasRight(index)&&this.heap[index]>this.getRightChild(index)) )){
            ...
            if(!this.hasRight(index)){
                ...
                if(this.getLeftChild(index)<=this.getRightChild(index)) [this.heap[index],this.heap[index*2+1]]=[this.getLeftChild(index),this.heap[index]]
                else (this.getLeftChild(index)>this.getRightChild(index))[this.heap[index],this.heap[index*2+2]]=[this.getRightChild(index),this.heap[index]]
